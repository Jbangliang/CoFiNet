...
datas = [train_data1]
in_fracs = ['Average Attention (OQMD_Formation_Enthalpy)']
...
for data, in_frac  in zip(datas, in_fracs):
    ...
    # model.load_network(r'D:\CrabNet-master\publication_CrabNet\models\trained_models\OQMD_Formation_Enthalpy.pth')
    hook_handles = []
